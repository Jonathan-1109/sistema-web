...
export function ConclusionPanel({
  ...
  return (
<div className="panel p-6 relative overflow-hidden animate-fade-up min-h-[450px] h-auto flex flex-col justify-between">
  <div className="absolute top-0 right-0 w-32 h-32 bg-violet/8 rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none" />
  ...
  <div>
    ...
    <div className="prose-sm text-ink-soft leading-relaxed whitespace-pre-wrap font-sans text-[14px]">
      {text.replaceAll("*", "")}
    </div>
  </div>
</div>
